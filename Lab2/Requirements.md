...
| Вход в приложение без создания собственного профиля.                  | Приложение предоставляет возможность войти в приложение анонимно.                                                                             
   йцуц==уцкккккккккккккккккккуцйкк к+|
| <a name="registration_requirem7ггггггггггггггггггггггггшшшents"/>Регистрация нового пользователя. | Приложение должно запросить у пользователя ввести личные для создания учётной записи. Пользователь должен либо ввести данные, либо отменить действие. |
