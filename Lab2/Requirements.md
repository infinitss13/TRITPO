...
[3.1.1.2 Заказ такси](#3112-заказ-такси)  
[3.1.1.3 Просмотр поездок пользователя](#3113-просмотр-поездок-пользователя)  
[3.1.1.4 Функции водителя](#3114-функции-водителя)
...
| *Пользователь с таким именем существует.*                             | *Приложение должно известить пользователя об ошибке регистрации и запросить ввод. Пользователь должен либо ввести новые данные* |
