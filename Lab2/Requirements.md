...
| *Пользователь с такими данными уже существует.*                       | *Приложение должно известить пользователя об ошибке регистрации и запросить ввод. Пользователь должен ввести новые данные* |
